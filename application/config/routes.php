...
$route['admin/reports/sales'] = 'admin/reports/sales';
$route['admin/reports/stock'] = 'admin/reports/stock';
$route['admin/reports/export-sales'] = 'admin/reports/export_sales';
$route['admin/reports/export-stock'] = 'admin/reports/export_stock';
