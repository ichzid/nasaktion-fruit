...
|
*/
$config['encryption_key'] = 'n4s4kt10n_fr00t_crm_s3cr3t_k3y_2024';
...
$config['csrf_token_name'] = 'csrf_nasaktion';
$config['csrf_cookie_name'] = 'csrf_nasaktion_cookie';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array('admin/pos.*', 'customer/cart.*');
